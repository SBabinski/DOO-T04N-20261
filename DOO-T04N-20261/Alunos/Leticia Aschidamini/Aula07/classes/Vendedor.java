...
public class Vendedor extends Pessoa {
    ...
    public Vendedor(String nome, int idade, String loja, String estado, String cidade, String bairro, String rua, int numero, double salarioBase) {
        super(nome, idade);
        this.loja = loja;
    ...
    public void apresentarSe() {
        System.out.println("Vendedor - Nome: " + nome + ", Idade: " + idade + ", Loja: " + loja);
    }
